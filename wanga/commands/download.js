...
// ==================== MUSIC COMMAND (Voice Note) ====================

commands.push({

    name: 'music',

    description: 'Search and download song as voice note',
    ...
    async execute({ msg, from, sender, args, bot, sock, react, reply }) {
        ...
        try {
            ...
            await reply(`⬇️ *Downloading voice note:*\n🎵 ${title}\n⏰ ${timestamp}\n👤 ${author}`);
...
commands.push({
    ...
    async execute({ msg, from, sender, args, bot, sock, react, reply }) {
        ...
        try {
            ...
            await reply(`⬇️ *Downloading MP3 document:*\n🎵 ${title}\n⏰ ${timestamp}`);
...
commands.push({
    ...
    async execute({ msg, from, sender, args, bot, sock, react, reply }) {
        ...
        try {
            ...
            resultText += `📺 *YouTube Search Results*\n`;
...
commands.push({
    ...
    async execute({ msg, from, sender, args, bot, sock, react, reply }) {
        ...
        try {
            ...
            // Send as AUDIO message (music, not voice note)
