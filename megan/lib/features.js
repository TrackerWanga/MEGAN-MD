...
class FeatureHelper {
    ...
    async handleAntiDelete(deletedMsg, key, deleter, sender) {
        ...
        try {
            ...
            let chatInfo = isGroup ? 'Private Chat' : 'Private Chat';
    ...
    async handleAntiCall(callData) {
        ...
        try {
            ...
            const antiCall = this.db.getSetting('anticall', 'false');
            ...
            for (const call of callData) {
                ...
                if (call.status === 'offer') {
                    ...
                    const callMsg = this.db.getSetting('anticall_msg', config.MESSAGES.ANTICALL);
    ...
    async updateAutoBio() {
        ...
        try {
            ...
            const setting = this.db.getSetting('auto_bio', 'false');
    ...
    async setPresence(jid) {
        ...
        try {
            ...
            let presence = this.db.getSetting(
    ...
    async autoRead(msg) {
        ...
        try {
            ...
            const setting = this.db.getSetting('auto_read', 'false');
